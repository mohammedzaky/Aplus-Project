...
function getrecord($id){
 // try to solve problem Edit &  Delete
    $q="select * from stress where id=?;";
    $row=$db->getRow($q,array($id));
     $Admin_name=$row[1];
     $Admin_username=$row[2];
     $Admin_password=$row[3];
     $Admin_email=$row[4];
     $Admin_password=$row[5];
...
if(isset($_POST['submit2']))
{
        ...
        $tele=$_POST['popup_tel'];
         ...
         $q="UPDATE  admin  SET  Admin_name  =   ?  ,  Admin_username  =   ?  ,  Admin_password  =   ?   ,Admin_email =   ?  , Admin_telephone =   ?   WHERE  admin . Admin_ID  =   ?  ;";
...
if(isset($_POST['submit3']))
{
        $id=$_POST['del_popup_hdn'];
         ...
         $q="DELETE FROM `admin` WHERE `admin`.`Admin_ID` = ?";
       ...
       if(strlen($aname)>=3 && strlen($uname)>=3 && strlen($paswd)>=3)
            {
                ...
                if($chu=="a_")
                {
                    ...
                    $q="INSERT INTO  admin  ( Admin_name ,  Admin_username ,  Admin_password ,  Admin_email ,  Admin_telephone ) VALUES (?,?,?,?,?)";
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="A_1.4_admins/css/bootstrap.css">
        <link rel="stylesheet" href="A_1.4_admins/css/rtl.css">
        <link rel="stylesheet" href="A_1.4_admins/css/style.css">
        <script src="A_1.4_admins/js/jquery.css"></script>
        <script src="A_1.4_admins/js/bootstrap.min.js"></script>
        <script>
            ...
            <div class="container-fluid">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="active"><a href="A_1.4_admins.php">Admins</a></li>
        ...
        <div align="center" >
            <table class="table">
                <tr class="quesRow" scope="row">
                    <th>
                        <label class="profName"> Admin name </label>
                    </th>
                    <th>
                        <label class="profName"> Username </label>
                    </th>
                    <th>
                        <label class="profName"> Password </label>
                    </th>
                    <th>
                        <label class="profName"> E-mail </label>
                    </th>
                    <th>
                        <label class="profName"> Telephone </label>
                    </th>
                    <th></th>
                </tr>
                <tr>
            ...
            echo "<tr> 
                    ...
                    <td>
                        <div class='row_options'>
                            ...
                            <a id='edit_$i' onclick='editID($row[0],$i);' data-toggle='modal' data-target='#editAdmin' title='Edit' style='cursor: pointer;'>
...
?>
        ...
        <!--Edit ppopup-->
        <div align="center"class="addCourses modal fade" id="editAdmin" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <form method ="POST" >
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                             <h4 class="modal-title" id="exampleModalCenterTitle"><b> Admin information</b></h4>
                        </div>
