...
<html>
    <head>
        ...
        <link rel="stylesheet" href="P_1.3_courseDegrees/css/bootstrap.css">
        <link rel="stylesheet" href="P_1.3_courseDegrees/css/rtl.css">
        <link rel="stylesheet" href="P_1.3_courseDegrees/css/style.css">
        <script src="P_1.3_courseDegrees/js/jquery.css"></script>
        <script src="P_1.3_courseDegrees/js/bootstrap.min.js"></script>
    </head>
   ...
   <div align="center" >
            ...
            <div class="srch-up container" style="border-bottom: 0px;">
                <!--<form action="see.php" method="post">
                    <div class="group-i">
                     ...
                     $q2="select Course_ID from semester_course_professor where Semester_ID='$sny[0]' and Professor_ID='$pid[0]';";
                    /* $q2="select Course_ID from course where Course_name='$cn';";  */
                     ...
                     for($i=0;$i<$n;$i++)
                     {
                      ...
                      $cnn=$db->getRow($q3,array());
                       echo '<option value="'.$cnn[0].'">'.$cnn[0].'</option>';
                      }
                        ?>
                        </select>
                    </div>
          ...
          echo   '<table class="table" id="ooo">
                <tr class="clickable-row" data-href="P_1.3.1_termDegree.php?course='.$cn.'&profn='.$pn.'&trm='.$trm.'" scope="row">
                    <td>
                        <br>
                        <label>'.$cn.'</label>
                        <br><br>
             ...
             else
            {
               ...
               for($i=0;$i<$n;$i++)
               {
                ...
                $yy=$snyy[0][1];
                 echo
                '<tr class="clickable-row" data-href="P_1.3.1_termDegree.php?course='.$cnn[0].'&profn='.$pnn[0].'&trm='.$nn.' '.$yy.'" scope="row" style="color:#25556a;">
                    <td>
                        <br>
                        <label>'.$cnn[0].'</label>
                        <br><br>
